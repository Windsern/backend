...
class Building(models.Model):
    ...
    description = models.TextField(max_length=500, verbose_name="Адрес", blank=True, null=True)
    floors = models.IntegerField(verbose_name="Количество этажей", blank=True, null=True)
    year = models.IntegerField(verbose_name="Год начала строительства", blank=True, null=True)

    status = models.IntegerField(choices=STATUS_CHOICES, default=1, verbose_name="Статус")
    image = models.ImageField(upload_to="buildings", default="buildings/default.png", verbose_name="Фото")
...
class BuildingVerification(models.Model):
    ...
    class Meta:
        verbose_name = "Проверка-Корпус"
        verbose_name_plural = "Проверки-Корпуса"
